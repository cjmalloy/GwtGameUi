...
public class ScrollPanel extends Panel implements MouseUpHandler, MouseDownHandler,
  ...
  /**
   * Calculate the size of the children and resize the content panel to fit.
   */
